...
public class MenuView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LojasMenuItem = new javax.swing.JMenuItem();
        ...
        setTitle("Sistema de Controle de Frente de Lojas");
        setExtendedState(6);
        setMaximizedBounds(new java.awt.Rectangle(0, 0, 1366, 768));
        setSize(new java.awt.Dimension(0, 0));

        desktopPane.setBackground(javax.swing.UIManager.getDefaults().getColor("RadioButtonMenuItem.selectionBackground"));
        desktopPane.setToolTipText("");

        fileMenu.setMnemonic('f');
        fileMenu.setText("Cadastro");

        ProdutosMenuItem.setMnemonic('o');
        ...
        fileMenu.add(ProdutosMenuItem);

        LojasMenuItem.setMnemonic('s');
        LojasMenuItem.setText("Lojas");
        fileMenu.add(LojasMenuItem);

        UsuariosMenuItem.setMnemonic('a');
    ...
    private javax.swing.JMenuItem LojasMenuItem;
